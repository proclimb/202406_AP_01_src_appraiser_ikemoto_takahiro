		...
		<table border="0" cellpadding="5" cellspacing="1">
			...
			?>
				<tr>
					...
					<td class="list_td<?php print $i ?>"><?php print $sellCharge ?></td>ist_td<?php print $i ?>"><a href="javascript:form.act.value='stock';form.sName.value='<?php print $article ?>';form.sRoom.value='<?php print $room ?>';form.submit();">表示</a></td>
				</tr>
			<?php
				$i = ($i + 1) % 3;
			}
